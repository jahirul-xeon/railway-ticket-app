// ============================================================
// Shared ticket HTML template — used both for the downloadable PDF
// (expo-print) and the confirmation email (Trigger Email extension).
// ============================================================
...
export function ticketHtml(t: TicketData): string {
...
<body>
  <div class="ticket">
    ...
    <div class="bkid">${shortId(t.bookingId)}</div>
